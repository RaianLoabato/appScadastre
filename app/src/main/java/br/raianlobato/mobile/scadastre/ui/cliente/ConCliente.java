 ...
 */
public class ConCliente<Clinte> extends Fragment implements
    ...
    public static ConCliente newInstance(int columnCount) {
        ConCliente fragment = new ConCliente();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.view = inflater.inflate(R.layout.fragment_con_cliente_list, container, false);
...
*/
                    if (view instanceof RecyclerView) {
                        ...
                        recyclerView.setAdapter(
                                new ConClienteRecyclerViewAdapter(this.clientes));
                    }
                }else {
                    Snackbar mensagem = Snackbar.make(view,
